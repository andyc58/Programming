...
"#fff",a[0].style.background="#fff"),d.length&&(d[0].style.backgroundImage=c?e:"none"));k&&(k.style.background=c?n:"#fff")};g(!1);l.f18b07f0d8c04918896616e03e20239e(b[0],g)}var l=function(){},r=setInterval(function(){document&&document.body&&null!=document.body.getAttribute("data-pp")&&(clearInterval(r),chrome.runtime.sendMessage([11],function(b){chrome.runtime.lastError&&c.top.location.reload(!0);courseId=b[0];hostname=c.location.protocol+"//"+b[3]+b[4];background_account_type=b[5];l=new ddd0e0a173624fd0ba859e3e3ef9f31c(courseId,
hostname,"d2",c.location.hostname,p)}))})})($,window);
