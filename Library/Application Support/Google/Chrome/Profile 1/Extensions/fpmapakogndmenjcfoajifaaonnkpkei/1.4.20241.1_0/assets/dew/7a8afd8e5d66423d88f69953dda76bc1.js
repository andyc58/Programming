...
b.rel="stylesheet";document.head.appendChild(b);var c=new XMLHttpRequest;c.open("GET",chrome.extension.getURL("webassets/q38s.html"));c.onreadystatechange=function(){c.readyState==c.DONE&&200==c.status&&(document.body.insertAdjacentHTML("beforeend",c.responseText),a())};c.send()})(function(){g(function(a){if(a)chrome.runtime.sendMessage([1,window.location.origin,"3p"]),document.body.addEventListener("2fd3c96b5c764fadb33c47bbb9661a6e",e);else{if(a=document.getElementById("proctorio_3p_preparing_test"))a.style.display=
"none";if(a=document.getElementById("proctorio_3p_invalid_test"))a.style.display="block"}})})}})();
